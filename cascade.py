...
class harr_detector:
    def __init__(self):
        ...
        self.face_casecade.load(cv.data.haarcascades +"haarcascade_frontalface_alt2.xml")
        self.eye_casecade.load(cv.data.haarcascades +"haarcascade_eye_tree_eyeglasses.xml")
